...
export class EntitySheetHelper {
  ...
  static onAttributeRoll(event) {
    ...
    const shorthand = game.settings.get("npqv11", "macroShorthand");
  ...
  static async createDialog(data={}, options={}) {
    ...
    const templates = collection.filter(a => a.getFlag("npqv11", "isTemplate"));
    ...
    return Dialog.prompt({
      ...
      callback: html => {
        ...
        if ( template ) {
          ...
          delete createData.flags.npqv11.isTemplate;
        }
